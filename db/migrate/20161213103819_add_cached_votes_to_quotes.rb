class AddCachedVotesToQuotes < ActiveRecord::Migration
    def self.up
      ...
      add_column :quotes, :cached_weighted_score, :integer, :default => 0
      add_column :quotes, :cached_weighted_total, :integer, :default => 0
      add_column :quotes, :cached_weighted_average, :float, :default => 0.0
      ...
      add_index  :quotes, :cached_weighted_score
      add_index  :quotes, :cached_weighted_total
      add_index  :quotes, :cached_weighted_average
    ...
    def self.down
      ...
      remove_column :quotes, :cached_weighted_score
      remove_column :quotes, :cached_weighted_total
      remove_column :quotes, :cached_weighted_average
    end
