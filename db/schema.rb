...
ActiveRecord::Schema.define(version: 20161213103819) do
  ...
  add_index "quotes", ["cached_weighted_average"], name: "index_quotes_on_cached_weighted_average", using: :btree
  add_index "quotes", ["cached_weighted_score"], name: "index_quotes_on_cached_weighted_score", using: :btree
  add_index "quotes", ["cached_weighted_total"], name: "index_quotes_on_cached_weighted_total", using: :btree
